...
const schema = a.schema({
  Expert: a
    .model({
      ...
      managerTitle: a.string(),
      legalRepresentativeName: a.string(),
      legalRepresentativeTitle: a.string(),
      authorizedRepresentativeName: a.string(),
      authorizedRepresentativeTitle: a.string(),
  ...
  SupportTicket: a
    .model({
      ...
      screenshotS3Key: a.string(),
      screenshotContentType: a.string(),
      screenshotSize: a.integer(),
