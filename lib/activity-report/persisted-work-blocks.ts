...
export function buildPersistedWorkBlockBundles({
  ...
  return sortWorkBlocks(workBlocks.map((workBlock) => ({
    workBlock: {
      ...
      cleanedActivitySummary: workBlock.cleanedActivitySummary,
      generatedTableSummary: workBlock.generatedTableSummary,
      generatedNarrative: workBlock.generatedNarrative,
      generationInputsHash: workBlock.generationInputsHash,
      aiConsolidationStatus: workBlock.aiConsolidationStatus,
      aiConsolidationUpdatedAt: workBlock.aiConsolidationUpdatedAt,
