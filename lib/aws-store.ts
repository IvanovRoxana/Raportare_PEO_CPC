...
function mapExpert(item: any): Expert {
  return {
    ...
    legalRepresentativeTitle: item.legalRepresentativeTitle ?? undefined,
    authorizedRepresentativeName: item.authorizedRepresentativeName ?? undefined,
    authorizedRepresentativeTitle: item.authorizedRepresentativeTitle ?? undefined,
...
function mapSupportTicket(item: any): SupportTicket {
  return {
    ...
    screenshotS3Key: item.screenshotS3Key ?? undefined,
    screenshotContentType: item.screenshotContentType ?? undefined,
    screenshotSize: item.screenshotSize ?? undefined,
...
export const supportTicketsService = {
  ...
  async create(input: SupportTicketCreateInput): Promise<SupportTicket> {
    ...
    const result = await model.create(omitUndefinedFields({
      ...
      screenshotContentType: ticket.screenshotContentType,
      screenshotSize: ticket.screenshotSize,
  ...
  async update(id: string, updates: SupportTicketUpdateInput): Promise<SupportTicket | null> {
    ...
    const result = await model.update(omitUndefinedFields({
      ...
      screenshotFileName: updates.screenshotFileName,
      screenshotS3Key: updates.screenshotS3Key,
      screenshotContentType: updates.screenshotContentType,
      screenshotSize: updates.screenshotSize,
...
export const activityCatalogService = {
  ...
  async update(id: string, updates: Partial<Omit<ActivityCatalog, 'id' | 'createdAt'>>): Promise<ActivityCatalog> {
    ...
    const result = await client.models.ActivityCatalog.update({
      ...
      eventCategory: updates.eventCategory,
...
function mapActivityCatalog(item: any): ActivityCatalog {
  return {
    ...
    eventCategory: item.eventCategory ?? undefined,
