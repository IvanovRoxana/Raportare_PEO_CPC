...
export const aiEligibilityRulesetsService = awsStore.aiEligibilityRulesetsService;
export const aiEligibilityRuleVersionsService = awsStore.aiEligibilityRuleVersionsService;
...
export const monthAccessRequestsService = awsStore.monthAccessRequestsService;
