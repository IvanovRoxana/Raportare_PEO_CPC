...
export function buildActivityAutofillAuditPayload(input: {
  ...
  return {
    ...
    suggestedSaCode: input.suggestion.recommended.saCode,
    suggestedActivityName: input.suggestion.recommended.activityName,
    suggestedDescriptionPreview: preview(input.suggestion.recommended.description),
